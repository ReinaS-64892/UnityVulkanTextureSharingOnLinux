...
use vulkano::{
    ...
    memory::{
        ...
        sparse::SparseImageOpaqueMemoryBind,
    },
    pipeline::{
...
impl App {
    fn new(event_loop: &EventLoop<()>) -> Self {
        ...
        let texture = {
            ...
            let external_file_descriptor = get_fd_from_args();
            let raw_external_file_descriptor = external_file_descriptor.as_raw_fd();
            // rust はきっちりと解放してくれるから忘れないと file descriptor が閉じられてしまう。
            forget(external_file_descriptor);
            ...
            let image_memory = unsafe {
                DeviceMemory::import(
                    ...
                    MemoryAllocateInfo {
                        ...
                        // import する場合ここが Some でかつ external_memory_handle_types: ExternalMemoryHandleTypes::OPAQUE_FD の raw_image である必要があるっぽいわね
                        dedicated_allocation: Some(DedicatedAllocation::Image(&raw_image)),
                        ..Default::default()
                    },
                    vulkano::memory::MemoryImportInfo::Fd {
                        handle_type: ExternalMemoryHandleType::OpaqueFd,
                        file: File::from_raw_fd(raw_external_file_descriptor),
                    },
                )
                .unwrap()
            };
